...
The items hang together, so we can average them to form an index.
...
#### Robustness check with pre-registered censorship coding
...
#### Prepare functions for imputation
...
```
### Remove variables not needed after imputation
...
# Create and save final dataframes
...
# Create and save dataframe with censorship-related tokens by party and Congress

Data source: D. Card, S. Chang, C. Becker, J. Mendelsohn, R. Voigt, L. Boustan, R. Abramitzky, D. Jurafsky, Replication code and data for “Computational analysis of 140 years of US political
