...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Replicated Output Files}

\noindent All output files are located under \texttt{replication/dataverse\_files/}. Each subsection lists filenames relative to that directory's parent.

\subsection*{Figures --- Coefficient Plots}
\noindent Directory: \texttt{replication/dataverse\_files/figures/coefficient\_plots/}
\begin{itemize}[nosep]
  \item \texttt{\seqsplit{coefficient\_plot\_censorship\_consensus\_headline\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_censorship\_robustness\_checks\_anyheadline\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_censorship\_robustness\_checks\_coding\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_harm\_consensus\_headline\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_harm\_robustness\_checks\_anyheadline\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_harm\_robustness\_checks\_firstheadline\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_remove\_consensus\_headline\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_remove\_robustness\_checks\_anyheadline\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_remove\_robustness\_checks\_firstheadline\_si.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_remove\_robustness\_checks\_coding\_si.png}}
\end{itemize}

\subsection*{Figures --- Main Plots}
\noindent Directory: \texttt{replication/dataverse\_files/figures/main\_plots/}
\begin{itemize}[nosep]
  \item \texttt{\seqsplit{coefficient\_barplot\_anysubgroup.png}}
  \item \texttt{\seqsplit{coefficient\_barplot\_inaccsubgroup.png}}
  \item \texttt{\seqsplit{coefficient\_plot\_models\_combined\_main\_panel\_2.png}}
\end{itemize}

\subsection*{Figures --- Congress Speech Plot}
\noindent Directory: \texttt{replication/dataverse\_files/figures/paper/congress\_speech\_plot/}
\begin{itemize}[nosep]
  \item \texttt{congress\_speech\_plot.png}
\end{itemize}

\subsection*{Figures --- Sensitivity Plots}
\noindent Directory: \texttt{replication/dataverse\_files/figures/sensitivity\_plots/}
\begin{itemize}[nosep]
  \item \texttt{\seqsplit{rho-acme-censorship-controls-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-censorship-controls-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-censorship-nocontrols-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-censorship-nocontrols-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-harm-controls-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-harm-controls-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-harm-controls-mediation-democrats-accuracybinary-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-harm-controls-mediation-democrats-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-harm-nocontrols-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-harm-nocontrols-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-harm-nocontrols-mediation-democrats-accuracybinary-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-harm-nocontrols-mediation-democrats-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-remove-controls-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-remove-controls-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-remove-controls-mediation-democrats-accuracybinary-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-remove-controls-mediation-democrats-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-remove-nocontrols-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-remove-nocontrols-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-remove-nocontrols-mediation-democrats-accuracybinary-clusteredses.png}}
  \item \texttt{\seqsplit{rho-acme-remove-nocontrols-mediation-democrats-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-censorship-controls-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-censorship-controls-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-censorship-nocontrols-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-censorship-nocontrols-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-harm-controls-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-harm-controls-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-harm-controls-mediation-democrats-accuracybinary-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-harm-controls-mediation-democrats-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-harm-nocontrols-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-harm-nocontrols-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-harm-nocontrols-mediation-democrats-accuracybinary-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-harm-nocontrols-mediation-democrats-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-remove-controls-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-remove-controls-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-remove-controls-mediation-democrats-accuracybinary-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-remove-controls-mediation-democrats-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-remove-nocontrols-mediation-all-accuracybinary-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-remove-nocontrols-mediation-all-partyid-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-remove-nocontrols-mediation-democrats-accuracybinary-clusteredses.png}}
  \item \texttt{\seqsplit{rho-ade-remove-nocontrols-mediation-democrats-clusteredses.png}}
\end{itemize}

\subsection*{Tables --- Balance}
\noindent Directory: \texttt{replication/dataverse\_files/tables/balance/}
\begin{itemize}[nosep]
  \item \texttt{\seqsplit{balance-table-accuracy-selection-democrat.tex}}
  \item \texttt{\seqsplit{balance-table-accuracy-selection-republican.tex}}
  \item \texttt{balance-table-accuracyorder.tex}
  \item \texttt{balance-table-aligned-h1.tex}
\end{itemize}

\subsection*{Tables --- Descriptives}
\noindent Directory: \texttt{replication/dataverse\_files/tables/descriptives/}
\begin{itemize}[nosep]
  \item \texttt{consensus-headline-overview.tex}
  \item \texttt{descriptive\_stats.tex}
\end{itemize}

\subsection*{Tables --- Mediation}
\noindent Directory: \texttt{replication/dataverse\_files/tables/mediation/}
\begin{itemize}[nosep]
  \item \texttt{\seqsplit{mediation-all-accuracybinary-partyid-clusteredses.tex}}
  \item \texttt{mediation-all-partyid-clusteredses.tex}
  \item \texttt{\seqsplit{mediation-democrats-accuracybinary-clusteredses.tex}}
  \item \texttt{mediation-democrats-clusteredses.tex}
  \item \texttt{mediation-democrats-main-clusteredses.tex}
\end{itemize}

\subsection*{Tables --- Regression}
\noindent Directory: \texttt{replication/dataverse\_files/tables/regression/}
\begin{itemize}[nosep]
  \item \texttt{\seqsplit{byheadline-mainspecification-censorship-pro-dem-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{byheadline-mainspecification-censorship-pro-rep-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{byheadline-mainspecification-harm-pro-dem-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{byheadline-mainspecification-harm-pro-rep-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{byheadline-mainspecification-remove-pro-dem-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{byheadline-mainspecification-remove-pro-rep-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{mainmodel-mainspecification-censorship-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{mainmodel-mainspecification-harm-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{mainmodel-mainspecification-remove-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{tripleinteraction-mainspecification-censorship-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{tripleinteraction-mainspecification-harm-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{tripleinteraction-mainspecification-remove-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{withoutinteraction-mainspecification-censorship-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{withoutinteraction-mainspecification-harm-weighted-clusteredses-ld.tex}}
  \item \texttt{\seqsplit{withoutinteraction-mainspecification-remove-weighted-clusteredses-ld.tex}}
\end{itemize}
